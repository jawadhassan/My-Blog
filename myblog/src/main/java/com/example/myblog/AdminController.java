...
public class AdminController {
	...
	/*
	 * @PostMapping(path="/check/{check}",
	 * consumes=MediaType.APPLICATION_FORM_URLENCODED_VALUE,
	 * produces=MediaType.APPLICATION_JSON_VALUE) public @ResponseBody Root
	 * check(@PathVariable("check") String check,@RequestBody MultiValueMap
	 * paramMap) {
	 * 
	 ...
	 * "      \"4226\",\r\n" + "      \"2011/01/25\",\r\n" +
	 * "      \"$112,000\"\r\n" + "    ]\r\n" + "  ]\r\n" + " }";
	 * System.out.println("This is"+check.toString()); ArrayList<String>
	 * objectResult = new ArrayList<String>(); objectResult.add("Angelica");
	 * 
	 * objectResult.add("Ramos"); objectResult.add("System Architect");
	 * objectResult.add("London"); objectResult.add("9th Oct 09");
	 * objectResult.add("$2,875");
	 * 
	 * 
	 * Root root = new Root(); root.draw = 1; root.recordsTotal = 10;
	 * root.recordsFiltered = 2; root.data = new ArrayList<List<String>>();
	 * root.data.add(objectResult); //requestData.data = new
	 * ArrayList(objectResult); //return requestData; return root; }
	 */
